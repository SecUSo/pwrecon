...
enum {Page_Intro, Page_SelectMode, Page_SelectRecoveryMode, Page_SelectTestMode, Page_EnterPassword, Page_EnterHash, Page_ExtractCurrent, Page_AttackSettings, Page_Attack, Page_Results};
